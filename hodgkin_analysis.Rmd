...
rawcounts_path <- "/Users/pourmalm/Documents/Mellinghoff_lab/Data/hodgkin_project/nanostring/NanostringResults/09631_G_RawData.csv"
normcounts_path <- "/Users/pourmalm/Documents/Mellinghoff_lab/Data/hodgkin_project/nanostring/NanostringResults/06931_G_NormalizedData.csv"
samples_path <- "/Users/pourmalm/Documents/Mellinghoff_lab/Data/hodgkin_project/HodgkinLymphoma_Samples__V3.xlsx"
pDAPI_path <- "/Users/pourmalm/Documents/Mellinghoff_lab/Data/hodgkin_project/mpIF/results/data/220720_all_marker_counts_per_sample.xlsx"
pTumor_path <- "/Users/pourmalm/Documents/Mellinghoff_lab/Data/hodgkin_project/mpIF/results/data/220720_tumor_functional_marker_counts_per_sample.xlsx"
...
drop_cols <- c("File.Name", "X.1", "X20190924_09631.G.cart1_PanelStandard_12.RCC", "X20190924_09631.G.cart2_PanelStandard_12.RCC", "X20190925_09631.G.cart3_PanelStandard_12.RCC", "X20190925_09631.G.cart4_PanelStandard_12.RCC")



test<-rawcounts %>% 
  filter('Sample ID' == "Endogenous") %>% 
  select(-all_of(drop_cols))

# fix sample ID to match samples meta data, rename columns
rawcounts[rawcounts$File.Name == "Sample ID", ] <- sub('-', '_', rawcounts[rawcounts$File.Name == "Sample ID", ])
colnames(rawcounts) <- rawcounts[rawcounts$File.Name == "Sample ID", ]
...
#list of comparisons
comp <- c("EBV_final", "Treatment", "Diagnosis_abbrev", "MHCI_IHC_abbrev", "MHCII_IHC_abbrev", "B2M_IHC_abbrev", 
          "PDL1_IHC_abbrev", "PDL2_IHC", "CT2A_IHC_abbrev", "LMP1_IHC", "B-cell.rich/T-cell.rich/indeterminate")
